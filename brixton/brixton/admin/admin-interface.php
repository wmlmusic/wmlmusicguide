...
<div class="wrap" id="of_container">
  <div id="of-popup-save" class="of-save-popup">
    <div class="of-save-save">Options Updated - WPLOCKER.COM</div>
  </div>
...
public static function optionsframework_machine($options) {
  ...
  if(isset($_GET["import"]) && $_GET["import"] == 'start'){   
		...
		$theme_xml = PMC_PATH . 'import/brixton.gz';
...
public static function optionsframework_slider_function($id,$std,$oldorder,$order,$int, $social = false,  $menu = false, $sidebar = false){
	...
	if ($social){
	$slider .= '<label>Icon <a href="http://fortawesome.github.io/Font-Awesome/icons/" target="_blank">Font Awesome icon</a>. Only put icon name "fa-facebook-official" </label>';
	}
	else {	
		if(!$menu && !$sidebar){
