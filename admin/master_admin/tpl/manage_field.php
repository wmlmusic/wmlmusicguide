		...
		<div id="content-table-inner">
			...
			<div id="table-content" style="border:0px solid red">
				...
				<!--  end message-green -->
		 		...
		 		<form action="mpcontroller.php" method="post" id="fieldForm" autocomplete="off" enctype="multipart/form-data">
						...
						<table border="0" cellpadding="0" cellspacing="0" id="id-form" align="center" style="margin:0 auto;">
							...
							<tr>
								...
								<td>
									...
									<a href="field.php" class="form-reset"></a>
								</td>
							</tr>
						</table>
						</td>
				...
				<input type="hidden" name="mp_type" value="field" />
				...
				<tr <?php echo ($i%2 == 0) ? 'class="alternate-row"' : '' ?>>
					...
					<td class="options-width">
						<a href="field.php?id=<?php echo $value['mp_id'] ?>" title="Edit" class="icon-1 info-tooltip"></a>
						<a href="field.php?del_id=<?php echo $value['mp_id'] ?>" title="Delete" class="icon-2 info-tooltip"></a>
