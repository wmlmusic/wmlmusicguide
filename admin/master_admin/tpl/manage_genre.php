		...
		<div id="content-table-inner">
			...
			<div id="table-content" style="border:0px solid red">
				...
				<!--  end message-green -->
		 		...
		 		<form action="mpcontroller.php" method="post" id="genreForm" autocomplete="off" enctype="multipart/form-data">
		 			...
		 			<tr>
						...
						<table border="0" cellpadding="0" cellspacing="0" id="id-form" align="center" style="margin:0 auto;">
									...
									<?php 
										if($data['categories']):
											foreach ($data['categories'] as $key => $value) {
												$selectd = $parent_id == $value['mp_id'] ? 'selected' : '';
									?>
										<option value="<?php echo($value['mp_id']) ?>" <?php echo $selectd ?> ><?php echo($value['mp_name']) ?>
										</option>
									<?php
											}
										endif;
							...
							<tr>
								...
								<td>
									...
									<a href="genre.php" class="form-reset"></a>
								</td>
							</tr>
						</table>
						</td>
						...
						<table>
							<tr>
								<td>
									<?php if($id>0){
										echo '&nbsp;<img src="../../uploads/category_' . $id . '.jpg" height="120" />';
									}
									?>
								</td>
							</tr>
				...
				<input type="hidden" name="mp_type" value="genre" />
				...
				<tr <?php echo ($i%2 == 0) ? 'class="alternate-row"' : '' ?>>
					...
					<td class="options-width">
						<a href="genre.php?id=<?php echo $value['mp_id'] ?>" title="Edit" class="icon-1 info-tooltip"></a>
						<a href="genre.php?del_id=<?php echo $value['mp_id'] ?>" title="Delete" class="icon-2 info-tooltip"></a>
