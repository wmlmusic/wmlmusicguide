		...
		<div id="content-table-inner">
			...
			<div id="table-content" style="border:0px solid red">
				...
				<!--  end message-green -->
		 		...
		 		<form action="mpcontroller.php" method="post" id="categoryForm" autocomplete="off" enctype="multipart/form-data">
		 			...
		 			<tr>
						...
						<table border="0" cellpadding="0" cellspacing="0" id="id-form" align="center" style="margin:0 auto;">
							<tr>
								...
								<td><input type="text" class="inp-form" name="txtfield" required minlength="2" value="<?php echo $name ?>" /></td>
							</tr>
							<tr>
								<td valign="top">Image:</td>
								<td><input type="file" class="file_1" accept="image/*" name="category_image" /></td>
							</tr>
							<tr>
								<td valign="top">&nbsp;</td>
								<td>
									<input type="submit" value="" class="form-submit" />
									<a href="category.php" class="form-reset"></a>
								</td>
							</tr>
						</table>
						</td>
				...
				<input type="hidden" name="mp_type" value="category" />
				...
				<tr <?php echo ($i%2 == 0) ? 'class="alternate-row"' : '' ?>>
					...
					<td class="options-width">
						<a href="category.php?id=<?php echo $value['mp_id'] ?>" title="Edit" class="icon-1 info-tooltip"></a>
						<a href="category.php?del_id=<?php echo $value['mp_id'] ?>" title="Delete" class="icon-2 info-tooltip"></a>
