...
<div id="content">
	...
	<!--				<td class="red-left">Error. <a href="">Please try again.</a></td>
			...
			<!--		<td class="blue-left">Welcome back. <a href="">View my account.</a> </td>
				...
				<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td class="green-left">User Information Updated Sucessfully. </td>
				...
				<tr>
					...
					<a href="http://wmlmusicguide.com/site/admin/master_admin/addcontact_info.php?act=edit&id=<?php echo $users_details['id']; ?>" title="Edit" class="icon-1 info-tooltip"></a>
