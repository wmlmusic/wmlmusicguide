		...
		<div id="content-table-inner">
			...
			<div id="table-content" style="border:0px solid red">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a href="" class="nobg">Company Name</a></th>
				...
				<tr <?php echo ($i%2 == 0) ? 'class="alternate-row"' : '' ?>>
					...
					<td class="options-width">
						<a href="company_form.php?id=<?php echo $value['id'] ?>" title="Edit" class="icon-1 info-tooltip"></a>
						<a href="social_form.php?type=company&amp;id=<?php echo $value['id'] ?>" title="Social Media" class="icon-3 info-tooltip"></a>
						<a href="company.php?del_id=<?php echo $value['id'] ?>" title="Delete" class="icon-2 info-tooltip"></a>
