...
<div class="nav-outer"> 
		...
		<ul class="select" ><li><a href="#nogo"><b>Users</b><!--[if IE 7]><!--></a><!--<![endif]-->
		...
		<ul class="current"><li><a href="#nogo"><b>Gallery</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub show">
			<ul class="sub">
				<li class="sub_show"><a href="addpicture.php">Add Pictures</a></li>
