			...
			<div id="table-content" style="border:0px solid red">		
				...
				<form id="postForm" action="postcontroller.php" method="post" enctype="multipart/form-data">
					...
					<tr>
						...
						<td><input type="text" class="inp-form required" name="name" value="<?php if(isset(stripcslashes($data['row']['name']))) echo $data['row']['name']; ?>" /></td>
					</tr>
					<tr>
						<th valign="top">Description:</th>
						<td><textarea class="form-textarea" cols="" rows="" name="details"><?php if(isset(stripcslashes($data['row']['details'])) echo stripcslashes($data['row']['details']); ?></textarea></td>
						<td></td>
					</tr>					
					<tr>
					...
					<tr>
						...
						<td>
							<select name="category">
								...
								<option value="image" <?php if(isset($data['row']['category']) && $data['row']['category'] == 'image') echo "selected";  ?>>Image</option>
