...
<tr>
	...
	<td>
		...
		<!-- <div id="step-holder">
			...
			<div class="step-dark-left"><a href="newgallery.php">Add pics in New Gallery</a></div>
		...
		<input type="hidden" name="gallery_id" value="<?php echo $data['id']; ?>" />
			...
			<tr>
			<th>Cover Image :</th>
			<td><?php if(!empty($data['customer_gallery_cover_image'])){ ?><img src="<?php echo $data['gallery_path'].$data['customer_gallery_cover_image']; ?>" alt="<?php echo $data['customer_gallery_cover_image']; ?>" width="50" height="50" /><?php } ?></td>
			...
			<th>Image 1:</th>
			<td>
			<?php if(!empty($data['customer_gallery_image1'])){ ?>
			<img src="<?php echo $data['gallery_path'].$data['customer_gallery_image1']; ?>" alt="<?php echo $data['customer_gallery_image1']; ?>" width="50" height="50" />
			<?php } ?>
			</td>
			...
			<tr>
			<th>Image 2:</th>
			<td><?php if(!empty($data['customer_gallery_image2'])){ ?><img src="<?php echo $data['gallery_path'].$data['customer_gallery_image2']; ?>" alt="<?php echo $data['customer_gallery_image2']; ?>" width="50" height="50" /><?php } ?></td>
			...
			<tr>
			<th>Image 3:</th>
			<td><?php if(!empty($data['customer_gallery_image3'])){ ?><img src="<?php echo $data['gallery_path'].$data['customer_gallery_image3']; ?>" alt="<?php echo $data['customer_gallery_image3']; ?>" width="50" height="50" /><?php } ?></td>
			...
			<tr>
			<th>Image 4:</th>
			<td><?php if(!empty($data['customer_gallery_image4'])){ ?><img src="<?php echo $data['gallery_path'].$data['customer_gallery_image4']; ?>" alt="<?php echo $data['customer_gallery_image4']; ?>" width="50" height="50" /><?php } ?></td>
