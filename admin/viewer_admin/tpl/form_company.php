			...
			<div id="table-content" style="border:0px solid red">		
				...
				<form id="companyForm" action="cmpycontroller.php" method="post" enctype="multipart/form-data">
					...
					<tr>
						...
						<td>
						<input type="text" class="inp-form required" name="company_name" required value="<?php if(isset($data['row']['cname'])) echo $data['row']['cname']; ?>" />
						</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					...
					<tr>
						...
						<td>
						<input type="text" class="inp-form" name="company_address" value="<?php if(isset($data['row']['address'])) echo $data['row']['address']; ?>" />
						</td>
						<th>City:</th>
						<td>
						<input type="text" class="inp-form" name="company_city" value="<?php if(isset($data['row']['city'])) echo $data['row']['city']; ?>" />
						</td>
					</tr>
					<tr>
						<th valign="top">State:</th>
						<td>
						<input type="text" class="inp-form" name="company_state" value="<?php if(isset($data['row']['state'])) echo $data['row']['state']; ?>" />
						</td>
						<th>Zip Code:</th>
						<td>
						<input type="text" class="inp-form" name="company_zip" value="<?php if(isset($data['row']['zipcode'])) echo $data['row']['zipcode']; ?>" />
						</td>
					</tr>
					<tr>
						<th valign="top">Country:</th>
						<td>
						<input type="text" class="inp-form" name="company_country" value="<?php if(isset($data['row']['country'])) echo $data['row']['country']; ?>" />
						</td>
						<th>&nbsp;</th>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<th>Phone:</th>
						<td>
						<input type="text" class="inp-form" name="company_phone" value="<?php if(isset($data['row']['phone'])) echo $data['row']['phone']; ?>" />
						</td>
						<th>Phone 1:</th>
						<td>
						<input type="text" class="inp-form" name="company_phone1" value="<?php if(isset($data['row']['phone1'])) echo $data['row']['phone1']; ?>" />
						</td>
					</tr>
					<tr>
						<th>Phone 2:</th>
						<td>
						<input type="text" class="inp-form" name="company_phone2" value="<?php if(isset($data['row']['phone2'])) echo $data['row']['phone2']; ?>" />
						</td>
						<th>Fax No:</th>
						<td>
						<input type="text" class="inp-form" name="company_faxno" value="<?php if(isset($data['row']['fax_no'])) echo $data['row']['fax_no']; ?>" />
						</td>
					</tr>
					...
					<tr>
						...
						<td>
						<input type="email" class="inp-form" name="company_email" required value="<?php if(isset($data['row']['email'])) echo $data['row']['email']; ?>" />
						</td>
					...
					<tr>
						...
						<td>
						<input type="email" class="inp-form" name="company_email2" value="<?php if(isset($data['row']['email2'])) echo $data['row']['email2']; ?>" />
						</td>
						<th>&nbsp;</th>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<th>Website:</th>
						<td>
						<input type="url" class="inp-form" name="company_url" value="<?php if(isset($data['row']['website'])) echo $data['row']['website']; ?>" />
						</td>
						<th valign="top">Profile Link URL:</th>
						<td>
						<input type="url" class="inp-form" name="company_profilelink" value="<?php if(isset($data['row']['profile_link'])) echo $data['row']['profile_link']; ?>" />
						</td>
					...
					<tr>
						...
						<td>
						<input type="text" class="inp-form" name="company_vpresident" value="<?php if(isset($data['row']['vice_president'])) echo $data['row']['vice_president']; ?>" />
						</td>
					</tr>
					<tr>
						<th valign="top">CEO:</th>
						<td>
						<input type="text" class="inp-form" name="company_ceo" value="<?php if(isset($data['row']['ceo'])) echo $data['row']['ceo']; ?>" />
						</td>
						<th>Co-CEO:</th>
						<td>
						<input type="text" class="inp-form" name="company_vceo" value="<?php if(isset($data['row']['vice_ceo'])) echo $data['row']['vice_ceo']; ?>" />
						</td>
					</tr>
					<tr>
						<th valign="top">Director:</th>
						<td>
						<input type="text" class="inp-form" name="company_director" value="<?php if(isset($data['row']['director'])) echo $data['row']['director']; ?>" />
						</td>
						<th>Manager:</th>
						<td>
						<input type="text" class="inp-form" name="company_manager" value="<?php if(isset($data['row']['manager'])) echo $data['row']['manager']; ?>" />
						</td>
					</tr>
					<tr>
						<th valign="top">A&R:</th>
						<td>
						<input type="text" class="inp-form" name="company_ar" value="<?php if(isset($data['row']['aandr'])) echo $data['row']['aandr']; ?>" />
						</td>
						<th>General Manager:</th>
						<td>
						<input type="text" class="inp-form" name="company_gmanager" value="<?php if(isset($data['row']['general_manager'])) echo $data['row']['general_manager']; ?>" />
						</td>
					</tr>
					<tr>
						<th valign="top">Road Manager:</th>
						<td>
						<input type="text" class="inp-form" name="company_rmanager" value="<?php if(isset($data['row']['road_manager'])) echo $data['row']['road_manager']; ?>" /></td>
						<th>Administration:</th>
						<td>
						<input type="text" class="inp-form" name="company_administration" value="<?php if(isset($data['row']['administration'])) echo $data['row']['administration']; ?>" />
						</td>
					</tr>					
					<tr>
						...
						<th>Picture:</th>
						<td>
						<input type="file" name="company_picture" />
						</td>
					</tr>
					<tr>
						<th valign="top">&nbsp;</th>
						...
						<th>Picture 1:</th>
						<td>
						<input type="file" name="company_picture1" />
						</td>
					</tr>
					<tr>
						<th valign="top">&nbsp;</th>
						...
						<th>Picture 2:</th>
						<td>
						<input type="file" name="company_picture2" />
						</td>
					</tr>
