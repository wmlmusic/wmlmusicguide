...
<div id="content">
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<?php 
				if(isset($_GET['act']) && ($_GET['act'] == 'add' || $_GET['act'] == 'updated')) { 
					$msg = $_GET['act'] == 'add' ? 'New client/artist added successfully.' : 'Client/artist updated successfully.';
			?>
			...
			<div id="table-content" style="border:0px solid red">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a href="" class="nobg">Artist Name</a></th>
