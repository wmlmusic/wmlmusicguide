...
<tr>
	...
	<td>
		...
		<tr>
			...
			<td><input type="text" name="username" value="<?php echo @$data['username']; ?>" class="inp-form" autocomplete="false" /></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Password:</th>
			<td><input type="password" name="password" value="" class="inp-form" /></td>
			<td>
		...
		<tr>
			...
			<td><input type="text" name="emailaddress" id="emailaddress" class="inp-form" value="<?php echo @$data['email']; ?>" /></td>
			<td>
