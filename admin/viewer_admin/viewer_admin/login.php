...
if(isset($_POST['forgot_password']) && $_POST['forgot_password'] == 'forgot'){
	...
	if(!empty($data['id'])){
		...
		header('Location: http://wmlmusicguide.com/site/admin/viewer_admin/login.php?act=sendmail');
		exit;
	}
}
?>
...
<div id="login-holder">
	...
	<form method="post" class="signin" action="logincontroller.php">
		...
		<tr>
			<!-- <th>Username</th> -->
			<th>Email Id</th>
			<td><input type="text" name="email"  class="login-inp" placeholder="abc@xyz.com" /></td>
		</tr>
		<tr>
			<th>Password</th>
