...
<div class="nav-outer"> 
		...
		<div class="select_sub show">
			<ul class="sub">
				<li <?php if(curPageName()=='adduser.php'){ ?> class="sub_show" <?php } ?>><a href="adduser.php">Add Users</a></li>
				
				<li <?php if(curPageName()=='viewusers.php'){ ?> class="sub_show" <?php } ?>><a href="viewusers.php">View All Users</a></li>
			</ul>
		</div>
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
		</li>
