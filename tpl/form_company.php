			...
			<div id="table-content" style="border:0px solid red">		
				...
				<form id="companyForm" action="cmpycontroller.php" method="post" enctype="multipart/form-data">
					...
					<tr>
						...
						<td>
						<input type="text" class="inp-form" name="company_suiteno" value="<?php if(isset($data['row']['suite_no'])) echo $data['row']['suite_no']; ?>" />
						</td>
						<th>PO Box #:</th>
					...
					<tr>
						...
						<th>Picture:</th>
						<td><input type="file" name="company_picture" accept="image/*" /></td>
					</tr>
					<tr>
						<th valign="top">&nbsp;</th>
						<td>&nbsp;</td>
						<th>Picture 1:</th>
						<td><input type="file" name="company_picture1" accept="image/*" /></td>
					</tr>
					<tr>
						<th valign="top">&nbsp;</th>
						<td>&nbsp;</td>
						<th>Picture 2:</th>
						<td><input type="file" name="company_picture2" accept="image/*" /></td>
					</tr>
					...
					<tr>
						...
						<td>
							...
							<a href="company.php" class="form-cancel">Cancel</a>
						</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					...
					<input type="hidden" id="comp_id" name="id" value="<?php echo $data['id'] ?>" />
				</form>
			</div>
...
<script>
	$().ready(function(){
		$('#companyForm').validate({
			...
			messages: {
				company_email: {
					minlength: 'Entered email address not found.'
				}
			},
			errorElement: 'span'		
		});
