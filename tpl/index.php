	...
	<link rel="stylesheet" type="text/css" href="public/css/jquery-ui-1.8.13.custom.css">
      	...
      	<div class="tab-wrapper">
			...
			?>
	      		<ul>
	        		...
	        		<li><a href="about_wml.php">Bio</a></li>
  		...
  		<div class="class_left">
	  		...
	  		?>
				<li>
					...
					<h3><?php echo $name ?></h3>
					<p><?php echo $details ?> <a href="<?php echo $data['banner_row']['banner_link'] ?>" target="_blank"> &raquo; view <?php echo $data['banner_row'] . $name ?></a> </p>
				</li>
			<?php 
					} 
			?>		
		...
		?>
			...
			?>
		 	...
		 	<div class="side-youtube">
				...
				$url="https://soundcloud.com/worldmusiclisting/sets/world-music-listing";
