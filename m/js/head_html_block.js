...
function get_header_html_text() {
	...
	if (kind == 'HTML') {
		...
		var sidePositionPanel = 'left',
			...
			content_links_font_color="#ff8604",
			//background style
		...
		var linkElement = document.createElement('link');
			...
			linkElement.setAttribute('href', 'assets/colorpicker/css/colorpicker.css');
			document.getElementsByTagName('head')[0].appendChild(linkElement);
		var linkElement = document.createElement('link');
			linkElement.setAttribute('rel', 'stylesheet');
			linkElement.setAttribute('type', 'text/css');
			linkElement.setAttribute('href', 'css/box-setting/box-setting.css');
			document.getElementsByTagName('head')[0].appendChild(linkElement);
		...
		loadScripts([ // loading necessary files
			"js/box-setting/jquery.cookies.2.2.0.min.js",
			"js/box-setting/box-setting.js",
			"assets/colorpicker/js/jquery.animate-colors-min.js",
