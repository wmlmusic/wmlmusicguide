...
(function ($) {
	$.accordionSlider = function (wrapper, settings) { 
		...
		var controls_play_url = 'js/dream-accordion/data/icons/controls_play.gif';
		var controls_pause_url = 'js/dream-accordion/data/icons/controls_pause.gif';
		var playBtnUrl = 'js/dream-accordion/data/icons/play2.png';
		if (useControls) {
		...
		function initAll(i) {
			...
			for (j; j < captionLen; j++) {
				...
				captionMaskerDiv = $("<div />").addClass("captionHolder").addClass('title'+j);
	...
	*/
	...
	if(useMouseWheel){
		...
		function createPlayBtn(div) { //play btn for video slide
			...
			}).attr('src', playBtnUrl).addClass('play_btn');
		}
		//*****************
		/*function hideScroll(){
