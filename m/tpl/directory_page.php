                    ...
                    <div id="gallery" class="content_resize"> 
                        <!-- content start -->                  
                          <div class="content_full_size">
                            <h2>World Music Listing: Diverse Music Guide</h2>
                            <div class="clr"></div>
                            <div class="sep"></div>
                            <div class="clr"></div>
                          <?php
                          ...
                          ?>
                              <div class="cols1">
                                <div class="four columns alpha ">
                                  <div class="col1">
                                    <div class="pic">
                                      <a  href="category_directory.php?id=<?php echo($cat_id)?>" style="color: rgb(255, 134, 4);">
                                ...
                                <div class="seven columns omega">
                                  <div class="col1 last">
                                    <h3><a href="category_directory.php?id=<?php echo($cat_id)?>" style="color: rgb(28, 28, 28); font-size: 14px;"><?php echo ucwords($cat_name);?></a></h3>
                                  </div>
                                </div>
                                <div class="clr"></div>
                              </div>
