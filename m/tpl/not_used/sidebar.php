            ...
            <div style="border:0px solid red; margin:0 0 5px 0;">
                ...
                <div class="sidebar_flickr">
                    ...
                    <div class="sidebar_padding">
						<div class="flickr">
							<iframe src="http://widget.websta.me/in/<?php echo $instagram_name[1] ?>/?r=1&w=1&h=1&b=1&p=1" allowtransparency="true" frameborder="0" scrolling="no" style="border:none;overflow:hidden;width:60px; height: 60px" >
							</iframe>
						</div>
                    <div class="clr"></div>
					</div>
                ...
                <div class="sidebar_text">
                    ...
                    <div class="sidebar_padding">                      	          
						<br /><br />
						<div class="fb-page" data-href="<?php echo $facebook_link?>" data-width="60" data-height="120" data-hide-cover="false" data-show-facepile="true" data-show-posts="true"></div>
                        <div class="clr"></div>
                    </div>
                    <div class="clr"></div>
				</div>                        
